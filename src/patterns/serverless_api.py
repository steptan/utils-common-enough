...
class ServerlessAPIPattern:
    ...
    def _create_network(self):
        ...
        use_cost_optimized = (
            self.pattern_config.get("cost_optimized", True) and 
    ...
    def _create_pattern_outputs(self):
        ...
        pattern_summary = {
            ...
            "cost_optimized": self.pattern_config.get("cost_optimized", True) and self.environment != "prod"
        }
    ...
    def get_default_config(environment: str = "dev") -> Dict[str, Any]:
        ...
        return {
            "pattern": {
                "lambda_in_vpc": True,
                "cost_optimized": environment != "prod"
            },
            "network": {
                "vpc": {
                    "cidr": "10.0.0.0/16",
            ...
            "compute": {
                "lambda": {
                    ...
                    "timeout": 30,
                    "architecture": "arm64",
                    "reserved_concurrent_executions": None if environment != "prod" else 100,
                    "environment_variables": {
                    ...
                    "tables": [
                        {
                            ...
                            "encryption": True,
                            "stream_view_type": "NEW_AND_OLD_IMAGES" if environment == "prod" else None
                        }
                    ]
                }
            }
        ...
        if "compute" in config:
            ...
            if "lambda" in compute:
                ...
                if lambda_config.get("runtime") not in valid_runtimes:
                    errors.append(f"compute.lambda.runtime must be one of: {valid_runtimes}")
                ...
                if "memory_size" in lambda_config:
                    ...
                    if not isinstance(memory, int) or memory < 128 or memory > 10240:
                        errors.append("compute.lambda.memory_size must be between 128 and 10240")
