...
class FullStackAppPattern:
    ...
    def _get_allowed_origins(self) -> List[str]:
        ...
        allowed_origins.append(
            Sub("https://${Domain}", Domain=GetAtt(self.website.distribution, "DomainName"))
        )
    ...
    def _create_pattern_outputs(self):
        ...
        self.template.add_output(Output(
            "FrontendURL",
            Value=Sub("https://${Domain}", Domain=GetAtt(self.website.distribution, "DomainName")),
        ...
        pattern_summary = {
            ...
            "cost_optimized": self.api_config.get("pattern", {}).get("cost_optimized", True) and self.environment != "prod"
        }
    ...
    def get_frontend_url(self) -> Any:
        ...
        return Sub("https://${Domain}", Domain=GetAtt(self.website.distribution, "DomainName"))
