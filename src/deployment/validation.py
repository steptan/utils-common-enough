...
class PreDeploymentValidator:
    ...
    def validate_all(self, skip_categories: Optional[List[str]] = None) -> List[ValidationCheck]:
    ...
    def check_config_files(self) -> List[ValidationCheck]:
        ...
        required_files = [
            ...
            (f"config/environments/{self.environment}.yaml", "Environment configuration"),
