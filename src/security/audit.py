...
class SecurityAuditor:
    ...
    def audit_s3_buckets(self, resources: Dict[str, List[Dict[str, Any]]]) -> List[SecurityIssue]:
    ...
    def audit_lambda_functions(self, resources: Dict[str, List[Dict[str, Any]]]) -> List[SecurityIssue]:
    ...
    def audit_iam_roles(self, resources: Dict[str, List[Dict[str, Any]]]) -> List[SecurityIssue]:
    ...
    def audit_api_gateway(self, resources: Dict[str, List[Dict[str, Any]]]) -> List[SecurityIssue]:
        ...
        for api_resource in apis:
            ...
            try:
                ...
                stages = self.apigateway_client.get_stages(restApiId=api_id).get('item', [])
                for stage in stages:
    ...
    def audit_dynamodb_tables(self, resources: Dict[str, List[Dict[str, Any]]]) -> List[SecurityIssue]:
    ...
    def audit_cloudfront(self, resources: Dict[str, List[Dict[str, Any]]]) -> List[SecurityIssue]:
        ...
        for dist_resource in distributions:
            ...
            try:
                ...
                if viewer_protocol != 'redirect-to-https' and viewer_protocol != 'https-only':
                    issues.append(SecurityIssue(
    ...
    def audit_encryption(self, resources: Dict[str, List[Dict[str, Any]]]) -> List[SecurityIssue]:
    ...
    def audit_logging(self, resources: Dict[str, List[Dict[str, Any]]]) -> List[SecurityIssue]:
    ...
    def audit_public_access(self, resources: Dict[str, List[Dict[str, Any]]]) -> List[SecurityIssue]:
