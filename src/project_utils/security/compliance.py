...
class ComplianceChecker:
    ...
    def __init__(self, project_name: str, environment: str, region: str = "us-east-1"):
        ...
        self.trusted_advisor_client = self.session.client('support', region_name='us-east-1')  # Support API only in us-east-1
    ...
    def generate_report(self, checks: List[ComplianceCheck]) -> Dict[str, Any]:
        ...
        report["compliance_score"] = round((total_weighted / max_score) * 100, 2) if max_score > 0 else 0
