...
class StackDiagnostics:
    ...
    def get_recent_events(
        self, stack_name: str, limit: int = 20, hours: int = 24
    ) -> List[Dict[str, Any]]:
    ...
    def analyze_drift(self, stack_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            while True:
                status_response = (
                    self.cloudformation.describe_stack_drift_detection_status(
                ...
                if status == "DETECTION_COMPLETE":
                    ...
                    drift_info["error"] = status_response.get(
                        "DetectionStatusReason", "Unknown error"
                    )
                    return drift_info
