...
def deploy_complete_application(environment: str = "dev", auto_approve: bool = False):
    ...
    """
    print(f"🚀 Deploying complete Media Register application to {environment} environment")
    print()
    ...
    try:
        ...
        cmd = [
            "cdk", "synth",
            "--app", "python examples/complete_media_register_app.py",
        ...
        if not auto_approve:
            ...
            response = input(f"   Deploy Media Register to {environment}? [y/N]: ").strip().lower()
        ...
        deploy_cmd = [
            ...
            "--app", "python examples/complete_media_register_app.py",
            "--context", f"environment={environment}",
            "--require-approval", "never" if auto_approve else "broadening",
            "--outputs-file", f"outputs-{environment}.json"
        ]
