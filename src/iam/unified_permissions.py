...
class UnifiedPolicyGenerator:
    ...
    def generate_unified_cicd_policy(self, account_id: str, projects: List[str]) -> Dict[str, Any]:
        """
        ...
        cf_resources.append(f"arn:aws:cloudformation:{self.config.aws_region}:{account_id}:stack/CDKToolkit/*")
        ...
        ssm_resources.append(f"arn:aws:ssm:{self.config.aws_region}:{account_id}:parameter/cdk-bootstrap/*")
    ...
    def generate_project_specific_resources(self, project_name: str, account_id: str) -> Dict[str, Any]:
        """
...
def get_unified_cicd_policy(projects: List[str], account_id: str, region: str = "us-east-1") -> str:
    """
